...
void ContentLoader::RotateOverlayTexture(int begin, Float2 verts[4])
{
	...
	OverlayVerts[begin + 0]._X = verts[1]._1 / ScreenManagerSystem::GetScreenAspectRatio();
	OverlayVerts[begin + 1]._X = verts[3]._1 / ScreenManagerSystem::GetScreenAspectRatio();
	OverlayVerts[begin + 2]._X = verts[2]._1 / ScreenManagerSystem::GetScreenAspectRatio();

	OverlayVerts[begin + 3]._X = verts[3]._1 / ScreenManagerSystem::GetScreenAspectRatio();
	OverlayVerts[begin + 4]._X = verts[1]._1 / ScreenManagerSystem::GetScreenAspectRatio();
	OverlayVerts[begin + 5]._X = verts[0]._1 / ScreenManagerSystem::GetScreenAspectRatio();
